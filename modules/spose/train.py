...
def initialize_args():
    ...
    class IDEArgs:
        def __init__(self):
            ...
            self.triplets_dir = './test/test_results/triplets/dataset'  # No default for directories, must be set if needed
            self.results_dir = './test/test_results/triplets/results'
            self.plots_dir = './test/test_results/triplets/plots'
            self.learning_rate = 0.001
            self.lmbda = 0.008  # Must be explicitly set if used in IDE
            self.temperature = 1.
            self.embed_dim = 100
            self.batch_size = 128
            self.epochs = 500
